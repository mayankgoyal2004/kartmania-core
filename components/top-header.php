    ...
    <ul class="flex-align flex-wrap d-none d-xl-flex">
        ...
        <li class="border-right-item pe-12 me-12">
            <a href="javascript:void(0)"
                ...
                <img src="<?= getenv("BASE_URL")."/assets/"?>/images/icon/track-icon.png" alt="Track Icon">
            ...
            <ul
                ...
                <li>
                    <a href="javascript:void(0)"
                        ...
                        <img src="<?= getenv("BASE_URL")."/assets/"?>/images/thumbs/flag1.png" alt=""
                ...
                <li>
                    <a href="javascript:void(0)"
                        class="hover-bg-gray-100 text-gray-500 text-xs py-6 px-16 flex-align gap-8 rounded-0">
                        <img src="<?= getenv("BASE_URL")."/assets/"?>/images/thumbs/flag2.png" alt=""
                            class="w-16 h-12 rounded-4 border border-gray-100">
                        Japan
                    </a>
                </li>
                <li>
                    <a href="javascript:void(0)"
                        class="hover-bg-gray-100 text-gray-500 text-xs py-6 px-16 flex-align gap-8 rounded-0">
                        <img src="<?= getenv("BASE_URL")."/assets/"?>/images/thumbs/flag3.png" alt=""
                            class="w-16 h-12 rounded-4 border border-gray-100">
                        French
                    </a>
                </li>
                <li>
                    <a href="javascript:void(0)"
                        class="hover-bg-gray-100 text-gray-500 text-xs py-6 px-16 flex-align gap-8 rounded-0">
                        <img src="<?= getenv("BASE_URL")."/assets/"?>/images/thumbs/flag4.png" alt=""
                            class="w-16 h-12 rounded-4 border border-gray-100">
                        Germany
                    </a>
                </li>
                <li>
                    <a href="javascript:void(0)"
                        class="hover-bg-gray-100 text-gray-500 text-xs py-6 px-16 flex-align gap-8 rounded-0">
                        <img src="<?= getenv("BASE_URL")."/assets/"?>/images/thumbs/flag6.png" alt=""
                            class="w-16 h-12 rounded-4 border border-gray-100">
                        Bangladesh
                    </a>
                </li>
                <li>
                    <a href="javascript:void(0)"
                        class="hover-bg-gray-100 text-gray-500 text-xs py-6 px-16 flex-align gap-8 rounded-0">
                        <img src="<?= getenv("BASE_URL")."/assets/"?>/images/thumbs/flag5.png" alt=""
                            class="w-16 h-12 rounded-4 border border-gray-100">
                        South Korea
                    </a>
                </li>
