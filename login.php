                ...
                <div class="row gy-4">
                    ...
                    <div class="col-xl-6 offset-xl-3 col-lg-8 offset-lg-2 col-md-10 offset-md-1">
                        <div
                            ...
                            <div class="mb-24">
                                <label for="username" class="text-neutral-900 text-lg mb-8 fw-medium">Email <span
                                        class="text-danger">*</span> </label>
                                <input type="email" class="common-input" id="username" name="email"
                                    placeholder="Enter Email">
                            </div>
                            <div class="mb-24">
                                <label for="password" class="text-neutral-900 text-lg mb-8 fw-medium">Password <span
                                        class="text-danger">*</span></label>
                                <div class="position-relative">
                            ...
                            <div class="mb-24 mt-48">
                                <div class="flex-align gap-48 flex-wrap">
                                    <button type="submit" name="submit" class="btn btn-main py-18 px-40">Log in</button>
                            ...
                            <div class="mt-24">
                                <a href="<?= getenv("BASE_URL") . "/register" ?>"
                                    class="text-primary-600 text-sm fw-semibold hover-text-decoration-underline">New
                                    Customer? Create an account now</a>
                            </div>
                            <div class="mt-24">
                                <a href="<?= getenv("BASE_URL") . "/forgot-password" ?>"
                                    class="text-danger-600 text-sm fw-semibold hover-text-decoration-underline">Forgot
                                    your password?</a>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#loginForm").on("submit", function (e) {
                ...
                $.ajax({
                    url: "<?php echo getenv('CUSTOMER_LOGIN_LOGIN'); ?>",
                    type: "POST",
                    ...
                    success: function (response, textStatus, xhr) {
                        if (xhr.status === 200) {
                            notyf.success("Customer Login successfully");
                            $("#loginForm")[0].reset(); // clear form
                        } else if (xhr.status === 401) {
                            notyf.error("Unauthorized: Invalid email/phone or password.");
                        } else {
